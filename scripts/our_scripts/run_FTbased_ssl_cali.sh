...
for model in visual_prompt ; do #textual_prompt visual_prompt multimodal_prompt
...
for meta_lr in '0.001'; do # 0.0002
    ...
    accelerate launch --config_file methods_config/accelerate_localtest_config.yml run_main_FT_ssl_cali.py --model_config ${dataset_name}_config.yml \
