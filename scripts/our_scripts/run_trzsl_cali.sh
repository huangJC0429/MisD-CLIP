...
for dataset_name in MNIST; do # DTD Flowers102 EuroSAT FGVCAircraft RESICS45 MNIST CUB
...
for optim_seed in 1; do # 1 2 3 4 5 are the seeds we used
    ...
    accelerate launch --config_file methods_config/accelerate_localtest_config.yml run_main_trzsl_cali.py --model_config ${dataset_name}_config.yml \
